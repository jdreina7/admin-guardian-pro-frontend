                ...
                <motion.div initial={{ opacity: 0, scale: 0.6 }} animate={{ opacity: 1, scale: 1, transition: { delay: 0.1 } }}>
                    ...
                    >
                        <g clipPath="url(#clip0)">
                            <path d="M0 51.1424C0 128.64 48.6181 191.351 108.701 191.351L0 51.1424Z" className="text-gray-800" fill="currentColor" />
                            <path d="M108.701 191.351C108.701 112.982 162.956 49.567 230.004 49.567L108.701 191.351Z" fill="currentColor" />
                            <path d="M39.3843 58.1677C39.3843 131.782 70.3872 191.351 108.701 191.351L39.3843 58.1677Z" fill="currentColor" />
                            <path
                            ...
                            <path
                                ...
                                fill="currentColor"
                            />
                            <path d="M1074.42 231.777H595.703V499.613H1074.42V231.777Z" className="text-gray-700" fill="currentColor" />
                            <path
                            ...
                            <path d="M316.609 159H108.609V401H316.609V159Z" className="text-gray-700" fill="currentColor" />
                            <path d="M337.609 135H87.6091V221H337.609V135Z" className="text-gray-800" fill="currentColor" />
                            <path d="M337.609 237H87.6091V323H337.609V237Z" className="text-gray-800" fill="currentColor" />
                            <path d="M337.609 339H87.6091V425H337.609V339Z" className="text-gray-800" fill="currentColor" />
                            ...
                            <path
                                ...
                                fill="currentColor"
                            />
                            <path d="M304.609 600H280.609V643H304.609V600Z" className="text-gray-800" fill="currentColor" />
                            <path d="M352.609 600H328.609V643H352.609V600Z" className="text-gray-800" fill="currentColor" />
                            <path
