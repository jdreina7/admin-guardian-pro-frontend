            ...
            <AppBar
                ...
                sx={{
                    backgroundColor: (theme) =>
                        theme.palette.mode === 'light' ? toolbarTheme.palette.background.paper : toolbarTheme.palette.background.default
                }}
                position="static"
                elevation={0}
            >
                        ...
                        {config.navbar.display && config.navbar.position === 'left' && (
                            <>
                                <Hidden lgDown>
                                    ...
                                    {config.navbar.style === 'style-1' && !navbar.open && <NavbarToggleButton className="mx-0 h-40 w-40 p-0" />}
                                </Hidden>
